...
public class Heartbeat : MonoBehaviour {
    ...
    [DllImport("AudioPluginAxelF")]
#elif UNITY_PS4
    [DllImport("libAudioPluginAxelF.prx")]
#elif UNITY_IOS
    [DllImport("__Internal")]
#endif
    static extern float AxelFGetAverageAmplitude();
    ...
    protected void Awake() {
        ...
        playerTransform = listenerTransform.parent;
    }
    ...
    protected void Update() {
        ...
        float normalized = AxelFGetAverageAmplitude() / ambienceWindInterpolatedThreshold;

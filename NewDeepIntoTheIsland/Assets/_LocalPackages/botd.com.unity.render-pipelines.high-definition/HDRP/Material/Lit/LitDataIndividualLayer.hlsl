...
//forest-begin: Procedural bark peel
		...
		float peelMask = saturate( (layerTexCoord.base.uv.y + _PeeledBarkUVRangeScale.x) / (_PeeledBarkUVRangeScale.y + dot(frac(GetObjectToWorldMatrix()._m03_m13_m23), _PeeledBarkUVRangeScale.zwz)) );

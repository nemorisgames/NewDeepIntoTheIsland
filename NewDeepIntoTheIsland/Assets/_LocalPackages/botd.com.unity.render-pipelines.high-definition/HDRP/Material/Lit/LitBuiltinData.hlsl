...
//forest-begin: sky occlusion / Tree Occlusion
    builtinData.bakeDiffuseLighting = SampleBakedGI(input.positionWS, bentNormalWS, input.texCoord1, input.texCoord2, surfaceData.skyOcclusion, grassOcclusion, surfaceData.treeOcclusion);
//forest-end:
...
//forest-begin: Tweakable transmission
        builtinData.bakeDiffuseLighting += SampleBakedGI(input.positionWS, -input.worldToTangent[2], input.texCoord1, input.texCoord2, surfaceData.skyOcclusion, grassOcclusion, surfaceData.treeOcclusion) * bsdfData.transmittance * _TransmissionDirectAndIndirectScales[bsdfData.diffusionProfile].g;
//forest-end:
//forest-end
    }

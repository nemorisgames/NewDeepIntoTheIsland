...
namespace AC
{
	...
	public class Speech
	{
			...
			if (hasTag)
			{
				if (isRTL)
				{
					...
					if (stringFromIndex.EndsWith (openBoldTag))
					{
						...
						closingTags = closingTags.Replace (openBoldTag, string.Empty);
					}
					else if (stringFromIndex.EndsWith (openItalicTag))
					{
						italicTagIndex = -1;
						newIndex -= openItalicTag.Length;
						closingTags = closingTags.Replace (openItalicTag, string.Empty);
					}
					else if (!string.IsNullOrEmpty (activeOpenSizeTag) && stringFromIndex.EndsWith (activeOpenSizeTag))
					{
						...
						closingTags = closingTags.Replace (activeOpenSizeTag, string.Empty);
						activeOpenSizeTag = string.Empty;
					}
					else if (!string.IsNullOrEmpty (activeOpenColorTag) && stringFromIndex.EndsWith (activeOpenColorTag))
					{
						...
						closingTags = closingTags.Replace (activeOpenColorTag, string.Empty);
						activeOpenColorTag = string.Empty;
					}
				...
				else
				{
					...
					if (stringFromIndex.StartsWith (closeBoldTag))
					{
						boldTagIndex = -1;
						newIndex += closeBoldTag.Length;
						closingTags = closingTags.Replace (closeBoldTag, string.Empty);
					}
					else if (stringFromIndex.StartsWith (closeItalicTag))
					{
						italicTagIndex = -1;
						newIndex += closeItalicTag.Length;
						closingTags = closingTags.Replace (closeItalicTag, string.Empty);
					}
					else if (stringFromIndex.StartsWith (closeSizeTag))
					{
						sizeTagIndex = -1;
						newIndex += closeSizeTag.Length;
						closingTags = closingTags.Replace (closeSizeTag, string.Empty);
					}
					else if (stringFromIndex.StartsWith (closeColorTag))
					{
						colorTagIndex = -1;
						newIndex += closeColorTag.Length;
						closingTags = closingTags.Replace (closeColorTag, string.Empty);
					}
		...
		{
			_message = _message.Replace (openBoldTag, string.Empty);
			_message = _message.Replace (openItalicTag, string.Empty);
			_message = _message.Replace (openSizeTag, string.Empty);
			_message = _message.Replace (openColorTag, string.Empty);

			_message = _message.Replace (closeBoldTag, string.Empty);
			_message = _message.Replace (closeItalicTag, string.Empty);
			_message = _message.Replace (closeSizeTag, string.Empty);
			_message = _message.Replace (closeColorTag, string.Empty);

	...
	public class Menu : ScriptableObject
	{
		...
		public void ShowGUI ()
		{
			...
			else if (appearType == AppearType.WhenSpeechPlays)
			{
				...
				if (oneMenuPerSpeech)
				{
					speechProximityLimit = (SpeechProximityLimit) CustomGUILayout.EnumPopup ("Limit by speaker proximity:", speechProximityLimit, apiPrefix + ".speechProximityLimit");
					if (speechProximityLimit != SpeechProximityLimit.NoLimit)
					{
						speechProximityDistance = CustomGUILayout.FloatField ("Max distance from speaker:", speechProximityDistance, apiPrefix + ".speechProximityDistance");
					}
				}
			...
			else
			{
				...
				{
					canvas = (Canvas) CustomGUILayout.ObjectField <Canvas> ("Linked Canvas prefab:", canvas, isInScene, apiPrefix + ".canvas");
				}

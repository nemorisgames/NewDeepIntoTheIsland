...
namespace AC
{
	...
	public class PathsEditor : Editor
	{
		...
		public override void OnInspectorGUI()
		{
			...
			_target.pathSpeed = (PathSpeed) EditorGUILayout.EnumPopup("Walk or run:", _target.pathSpeed);
			_target.pathType = (AC_PathType) EditorGUILayout.EnumPopup ("Path type:", _target.pathType);

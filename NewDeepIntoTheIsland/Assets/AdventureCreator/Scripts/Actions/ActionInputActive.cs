	...
	public class ActionInputActive : Action
	{
		...
		override public float Run ()
		{
			if (KickStarter.settingsManager != null && KickStarter.settingsManager.activeInputs != null)
			{
				...
				ACDebug.LogWarning ("Couldn't find the Active Input with ID=" + activeInputID);
				return 0f;
			}

			ACDebug.LogWarning ("No Active Inputs found! Is the Settings Manager assigned properly?");
			return 0f;
		}
